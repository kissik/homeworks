...
public class Controller {
    ...
    public void processUser(){
        ...
        model.setValue(inputStringValueWithScanner(sc, View.INPUT_HELLO, "Hello"));
        model.addValue(inputStringValueWithScanner(sc, View.INPUT_JAVA, "Java!"));

        view.printResult(View.OUTPUT_STRING, model.getValue());
    }
    ...
    public String inputStringValueWithScanner(Scanner sc, String msg, String pattern) {
        ...
        while( ! sc.hasNext(pattern)) {
            view.printMessage(View.WRONG_INPUT_INT_DATA + msg);
            sc.next();
        }
        return sc.next();
    }
